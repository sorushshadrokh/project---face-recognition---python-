...
class App:
    def __init__(self):
        ...
        self.register_new_user_button_main_window = util.get_button(self.main_window, 'ساخت کاربر جدید', 'gray',
    ...
    def register_new_user(self):
        ...
        self.accept_button_register_new_user_window = util.get_button(self.register_new_user_window, 'تایید', 'green', self.accept_register_new_user)
        self.accept_button_register_new_user_window.place(x=750, y=300)

        self.try_again_button_register_new_user_window = util.get_button(self.register_new_user_window, 'دوباره تلاش کنید', 'red', self.try_again_register_new_user)
    ...
    def accept_register_new_user(self):
        ...
        util.msg_box('موفق بود', 'ساخت کاربر با موفقیت انجام شد')
